...
package cirruspath.javax.security.auth.login;

import cirruspath.javax.security.auth.AuthPermission;
import cirruspath.javax.security.auth.Subject;
import cirruspath.javax.security.auth.callback.Callback;
import cirruspath.javax.security.auth.callback.CallbackHandler;
import cirruspath.javax.security.auth.callback.UnsupportedCallbackException;
import cirruspath.javax.security.auth.login.AppConfigurationEntry.LoginModuleControlFlag;
import cirruspath.javax.security.auth.spi.LoginModule;
...
public class LoginContext {
    ...
    /**
     * Warning: calling the method more than once may result in undefined behaviour if logout()
     * method is not invoked before.
     */
    ...
    /**
     * The real implementation of login() method whose calls are wrapped into appropriate
     * doPrivileged calls in login().
     */
    ...
    /**
     * The real implementation of logout() method whose calls are wrapped into appropriate
     * doPrivileged calls in logout().
     */
    ...
    /**
     * <p>
     * A class that servers as a wrapper for the CallbackHandler when we use installed
     * Configuration, but not a passed one. See API docs on the LoginContext.
     * </p>
     * <p>
