...
public class UnsupportedCallbackException extends Exception {
    ...
    /**
     * Creates a new exception instance and initializes it with just the unsupported
     * {@code Callback}, but no error message.
     *
    ...
    /**
     * Creates a new exception instance and initializes it with both the unsupported
     * {@code Callback} and an error message.
     *
     * @param callback the {@code Callback}
