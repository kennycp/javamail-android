...
/**
 * Governs the use of methods in this package and also its subpackages. A <i>target name</i> of the
 * permission specifies which methods are allowed without specifying the concrete action lists.
 * Possible target names and associated authentication permissions are:
 *
 * <pre>
